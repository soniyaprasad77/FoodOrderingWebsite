...
// const jsxHeading = <h1>They are great</h1>
// const Heading = () => {
//     return(
//     <div>
//         <h1>I am rendering a arrow functional component </h1>
//         <h2>It is awsome to learn react and using a bundler that is parcel</h2>
//     </div>
//     )
// }
    ...
    <>
      <div className="header">
        <div className="logo-container">
          <img
            className="logo"
            src="https://img.freepik.com/free-vector/delivery-service-illustrated_23-2148505081.jpg?size=626&ext=jpg&ga=GA1.1.1813483633.1703823472&semt=ais"
            alt="logo"
          />
        </div>
  ...
  return (
    <div className="body-container">
      ...
      <div div className="res-container">
        {/* <RestaurantCard res_name="Meghna Foods" res_cusines="Biryani, roti" stars="stars: 4.3"/>
        <RestaurantCard res_name="Vishnu Foods" res_cusines="All fast foods" stars="stars: 5.0"/>
        <RestaurantCard res_name="Vivan Fast Foods" res_cusines="Samosha, Burger, Momos" stars="stars: 4.8"/> */}
